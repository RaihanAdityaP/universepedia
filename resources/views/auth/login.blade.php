...
<head>
    ...
    <title>Login - Universepedia</title>
...
<body class="flex items-center justify-center">
    ...
    <div class="glass-card p-8 rounded-2xl shadow-2xl w-full max-w-md mx-4">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-300">Login to explore the universe</p>
        </div>
        ...
        <div class="text-center mt-6">
            <p class="text-gray-300">
                ...
                <a href="{{ route('register') }}" class="text-purple-400 font-semibold hover:text-purple-300 transition">Register here</a>
            </p>
        </div>

        <div class="mt-8 p-4 demo-card rounded-lg">
            <p class="text-sm text-white font-semibold mb-2">Demo Accounts:</p>
            <p class="text-xs text-gray-300">Admin: admin@universepedia.com / password</p>
            <p class="text-xs text-gray-300">Member: member@universepedia.com / password</p>
        </div>
    </div>
