            ...
            <div class="card space-card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <h5 class="card-title text-light mb-0">{{ $planet->name }}</h5>
                    ...
                    <div class="row text-center mb-3">
                        <div class="col-6">
                            <small class="text-muted d-block">Distance from Sun</small>
        ...
        <div class="col-12">
            <div class="card space-card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-4">{{ request()->hasAny(['search', 'type']) ? 'No planets match your search criteria.' : 'Start exploring the universe by adding your first planet!' }}</p>
